...
package com.irshadillias.tunegenerator.common;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    @Override
    public void process(Bitmap bitmap, TextView graphicOverlay) {
        detectInVisionImage(null /* bitmap */, FirebaseVisionImage.fromBitmap(bitmap), null,
                graphicOverlay);
    }
    ...
    private synchronized void processLatestImage(final TextView graphicOverlay) {
        processingImage = latestImage;
        processingMetaData = latestImageMetaData;
        latestImage = null;
        latestImageMetaData = null;
    ...
    protected abstract void onSuccess(
            ...
            @NonNull T results,
            @NonNull FrameMetadata frameMetadata,
            @NonNull TextView graphicOverlay);
