...
public class CloudDocumentTextRecognitionProcessor
    ...
    @Override
    protected void onSuccess(@Nullable Bitmap originalCameraImage, @NonNull FirebaseVisionDocumentText results, @NonNull FrameMetadata frameMetadata, @NonNull TextView graphicOverlay) {
